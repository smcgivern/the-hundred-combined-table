...
var previousYears = map[string]Rows{
	"2023": []Row{
		Row{"Brave",
			...
			RowSection{8, 4, 3, 0, 1, 891, 129.6, 954, 140},
		},
		Row{"Fire",
			RowSection{8, 5, 2, 0, 1, 997, 136, 942, 140},
			RowSection{8, 4, 3, 1, 0, 997, 141.6, 992, 139.8},
		},
		Row{"Invincibles",
			RowSection{8, 3, 4, 0, 1, 861, 140, 881, 135.2},
			RowSection{8, 6, 1, 1, 0, 1239, 158.2, 1163, 160},
		},
		Row{"N S-Chargers",
			RowSection{8, 6, 2, 0, 0, 988, 151.4, 945, 153.2},
			RowSection{8, 2, 5, 0, 1, 1048, 138, 1129, 136},
		},
		Row{"Originals",
			RowSection{8, 2, 4, 0, 2, 655, 115.6, 665, 103.2},
			RowSection{8, 4, 3, 0, 1, 993, 126, 920, 125},
		},
		Row{"Rockets",
			RowSection{8, 3, 4, 0, 1, 918, 130, 989, 140},
			RowSection{8, 3, 4, 0, 1, 1098, 140, 1060, 138.4},
		},
		Row{"Spirit",
			RowSection{8, 2, 4, 0, 2, 791, 117, 728, 113.4},
			RowSection{8, 2, 4, 0, 2, 890, 120, 956, 118.4},
		},
		Row{"Phoenix",
			RowSection{8, 0, 7, 0, 1, 822, 140, 920, 135.4},
			RowSection{8, 2, 4, 0, 2, 803, 120, 785, 115.8},
		},
	},
	"2022": []Row{
		Row{"Invincibles",
			RowSection{6, 5, 1, 0, 0, 754, 105.6, 725, 120},
			RowSection{8, 4, 4, 0, 0, 1205, 153, 1197, 159.8},
		},
		Row{"Rockets",
			RowSection{6, 3, 3, 0, 0, 679, 116.4, 626, 109.2},
			RowSection{8, 6, 2, 0, 0, 1258, 152.8, 1196, 156.2},
		},
		Row{"Brave",
			RowSection{6, 5, 1, 0, 0, 789, 110, 764, 120},
			RowSection{8, 3, 5, 0, 0, 1020, 149.2, 1162, 156.4},
		},
		Row{"Phoenix",
			RowSection{6, 3, 3, 0, 0, 723, 118.2, 718, 116.8},
			RowSection{8, 5, 3, 0, 0, 1116, 157.2, 1159, 159.4},
		},
		Row{"Originals",
			RowSection{6, 2, 4, 0, 0, 772, 120, 828, 119.8},
			RowSection{8, 5, 3, 0, 0, 1301, 159.8, 1140, 157.6},
		},
		Row{"N S-Chargers",
			RowSection{6, 3, 3, 0, 0, 836, 119.8, 829, 116.8},
			RowSection{8, 4, 4, 0, 0, 1219, 157, 1199, 154.6},
		},
		Row{"Spirit",
			RowSection{6, 2, 4, 0, 0, 686, 116.6, 711, 110.4},
			RowSection{8, 5, 3, 0, 0, 1164, 156.4, 1087, 153},
		},
		Row{"Fire",
			RowSection{6, 1, 5, 0, 0, 737, 120, 775, 113.6},
			RowSection{8, 0, 8, 0, 0, 979, 160, 1122, 148.4},
		},
	},
	"2021": []Row{
		Row{"Brave",
